<x-app-layout>
    <x-slot name="header">
        <div>
            <h2><i class="fas fa-plus-circle me-2 text-danger"></i>Ajouter une université</h2>
        ...
        <div class="col-12 col-lg-7">
            <div class="card card-admin">
                <div class="card-header">
                    <i class="fas fa-university me-2"></i> Nouvelle université
                </div>
                        ...
                        <div class="row gx-3">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" name="name" id="name"
                                       ...
                                       value="{{ old('name') }}" placeholder="ex: Université Norbert Zongo" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="acronym" id="acronym"
                                       ...
                                       value="{{ old('acronym') }}" placeholder="ex: UNZ">
