                    ...
                    <form action="{{ route('etudiants.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gx-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nom" id="nom" class="form-control text-uppercase-input @error('nom') is-invalid @enderror" value="{{ old('nom') }}" required>
                                @error('nom') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="prenom" class="form-label">Prénom <span class="text-danger">*</span></label>
                                <input type="text" name="prenom" id="prenom" class="form-control text-uppercase-input @error('prenom') is-invalid @enderror" value="{{ old('prenom') }}" required>
                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" name="telephone" id="telephone" class="form-control @error('telephone') is-invalid @enderror" value="{{ old('telephone') }}">
                        ...
                        <div class="row gx-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="universite" id="universite" class="form-control @error('universite') is-invalid @enderror" value="{{ old('universite') }}">
                                @error('universite') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row gx-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="discipline" id="discipline" class="form-control @error('discipline') is-invalid @enderror" value="{{ old('discipline') }}" required>
                                @error('discipline') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>

                            {{-- Upload propre de la photo --}}
                            <div class="col-md-6 mb-3">
                                <label for="photo_path" class="form-label">Photo de l’étudiant <span class="text-danger">*</span></label>
                                <div class="photo-upload">
                                    <img src="#" alt="Prévisualisation" class="photo-preview d-none" id="previewImage">
                                    <input type="file" name="photo_path" id="photo_path" class="form-control @error('photo_path') is-invalid @enderror" accept="image/*" required>
