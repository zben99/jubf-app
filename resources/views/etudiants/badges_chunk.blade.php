...
<div class="page">
    @foreach ($etudiants as $index => $etudiant)
        <div class="badge pos-{{ $index + 1 }}" style="background-image: url('{{ asset('images/badges/badge_template.png') }}');">
...
<div class="page">
    @foreach ($etudiants as $index => $etudiant)
        <div class="verso pos-{{ $index + 1 }}" style="background-image: url('{{ asset('images/badges/verso_template.png') }}');"></div>
    @endforeach
</div>
